...
//    	String Pass="A1b2c3qwert";
    ...
    //	final String file = "C:/SeleniumCases/namesChrome.txt" ;
    	...
    	String afterVote = "//*[contains(text(),'Ваша оценка') or contains(text(),'Вы уже голосовали за это фото')]";
...
//$x("//*[contains(text(),'Ваша оценка')]") //after vote
//$x("//*[contains(text(),'Ваша оценка') or contains(text(),'Вы уже голосовали за это фото')]") after vote
